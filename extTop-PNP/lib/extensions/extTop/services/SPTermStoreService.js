...
var SPTermStoreService = /** @class */ (function () {
     ...
     */
    SPTermStoreService.prototype.getTermsFromTermSetAsync = function (termSetName, termSetLocal) {
                ...
                switch (_a.label) {
                    case 0:
                        if (!(Environment.type === EnvironmentType.SharePoint ||
                            Environment.type === EnvironmentType.ClassicSharePoint)) return [3 /*break*/, 6];
                        ...
                        return [4 /*yield*/, this.spHttpClient.post(contextInfoUrl, SPHttpClient.configurations.v1, httpPostOptions)];
                    case 1:
                        response = _a.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.spHttpClient.post(clientServiceUrl, SPHttpClient.configurations.v1, httpPostOptions)];
                    case 3:
